...
public protocol DracoonNodes: Sendable {
    ...
    func createFileUpload(request: CreateFileUploadRequest, fileSize: Int64, completion: @Sendable @escaping (Dracoon.Result<CreateFileUploadResponse>) -> Void)
    ...
    func completeFileUpload(request: CompleteUploadRequest, uploadUrl: URL, completion: @Sendable @escaping (Dracoon.Result<Node>) -> Void)
...
public extension DracoonNodes {
    ...
    ///   - limit: Limits the number of returned nodes. Must be positive.
    ///   - completion: Returns a [list of nodes](x-source-tag://NodeList) on success or an error.
    func searchNodes(parentNodeId: Int64, searchString: String, depthLevel: Int?, filter: String?, offset: Int64?, limit: Int64?, completion: @Sendable @escaping (Dracoon.Result<NodeList>) -> Void) {
